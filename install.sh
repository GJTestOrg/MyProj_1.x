...
wget -O mantisbt-${VER}.zip https://sourceforge.net/projects/mantisbt/files/mantis-stable/${VER}/mantisbt-${VER}.zip/download > /dev/null
unzip mantisbt-${VER}.zip > /dev/null
sudo mv ./mantisbt-${VER}.zip /var/www/html/mantis
